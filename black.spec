...
Source0  : https://files.pythonhosted.org/packages/20/1b/e167bc0b94bebaa05bb337978b527f2a71bd67f8769ef5a8dbcb44b89c4b/black-21.7b0.tar.gz
...
%prep
%setup -q -n black-21.7b0
cd %{_builddir}/black-21.7b0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1626793026
...
cp %{_builddir}/black-21.7b0/LICENSE %{buildroot}/usr/share/package-licenses/black/edd079e7a759fe1fcf1d089e28b9c7df2080b42c
cp %{_builddir}/black-21.7b0/docs/_static/license.svg %{buildroot}/usr/share/package-licenses/black/e71d25df55070a88d192a9ecf3a7ad755e44e8ee
cp %{_builddir}/black-21.7b0/src/blib2to3/LICENSE %{buildroot}/usr/share/package-licenses/black/8482348f12824b36fba59883f9dd7fe03c1f86ca
