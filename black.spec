...
Source0  : https://files.pythonhosted.org/packages/b3/d6/d1aa2fdb633d092cf43ec4c96b0035a0a3a4f579b691205f96ccbd4e0032/black-21.5b2.tar.gz
...
%prep
%setup -q -n black-21.5b2
cd %{_builddir}/black-21.5b2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622557693
...
cp %{_builddir}/black-21.5b2/LICENSE %{buildroot}/usr/share/package-licenses/black/edd079e7a759fe1fcf1d089e28b9c7df2080b42c
cp %{_builddir}/black-21.5b2/docs/_static/license.svg %{buildroot}/usr/share/package-licenses/black/748f560ab176347fcb653c766cb3b5f91d99b4fd
cp %{_builddir}/black-21.5b2/src/blib2to3/LICENSE %{buildroot}/usr/share/package-licenses/black/8482348f12824b36fba59883f9dd7fe03c1f86ca
